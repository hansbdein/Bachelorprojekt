...
def makeorbits(kick, xyzstars, t):
    ...
    orbcoords=[[u.kpc*np.sqrt(abs(x**2+y**2)),vR*v,
                potential.vcirc(pot,u.kpc*np.sqrt(abs(x**2+y**2)))*220*u.km/u.s+vT*v
                ,u.kpc*z,
                vz*v,np.arctan2(x,y)*u.rad] for x,y,z,vR,vT,vz in coordscartesian]
